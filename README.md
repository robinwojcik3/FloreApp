...
`PLANTNET_API_KEY`, `GEMINI_API_KEY`, `TTS_API_KEY` et `CHROME_WS_ENDPOINT`.
...
`TTS_API_KEY` et `CHROME_WS_ENDPOINT` depuis l'environnement. `netlify dev` charge automatiquement le
