...
Ensuite, construis un tableau en Markdown où chaque espèce (nom latin seul) forme une colonne. N'inclus que les organes ou critères présentant des différences notables entre les espèces ; s'il n'y a aucune variation, omets la ligne correspondante. Structure les lignes autour des organes végétatifs puis reproducteurs (feuille, tige, racine, fleur, fruit, etc.) et consacre environ quatre cinquièmes du contenu à ces distinctions morphologiques. Ajoute une ligne spécifique résumant les différences écologiques principales. Chaque cellule doit être une phrase courte et précise rédigée dans une terminologie botanique rigoureuse. Les informations doivent provenir uniquement des champs "Critères physiologiques", "Écologie" et "Physionomie". N'utilise ni gras ni italique.
